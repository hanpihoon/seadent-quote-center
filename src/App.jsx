...
const [isLoggedIn, setIsLoggedIn] = React.useState(false);
  ...
  const exportQuotePdf = () => {
    ...
    win.document.write(`
      ...
      <div class="header"><div style="display:flex;align-items:flex-start;gap:14px"><img src="/logo.png" style="width:78px;object-fit:contain;margin-top:2px"/><div><div class="brand" style="margin-top:0">CÔNG TY CỔ PHẦN SEADENT</div><div class="sub">VP.HCM: 13 Đặng Tất, Phường Tân Định, TP.HCM<br/>VP.HN: Tầng 6, 110-112 Bà Triệu, Hà Nội<br/>Hotline: 0934831516<br/>Email: info@seadent.com.vn<br/>Website: seadent.com.vn</div></div></div><div class="meta" style="padding-top:2px"><b>Ngày:</b> ${new Date().toLocaleDateString("vi-VN")}<br/><b>Mã báo giá:</b> SQC-${Date.now()}</div></div>
      <h2>BẢNG BÁO GIÁ</h2>
