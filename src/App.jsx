  ...
  const exportQuotePdf = () => {
    ...
    win.document.write(`
      ...
      <style>
        ...
        .customer{background:#fff7ed;border:1px solid #fed7aa;padding:14px;border-radius:12px;margin-bottom:18px;line-height:1.8}table{width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;border-radius:14px;border:1px solid #e5e7eb}th{background:#f97316;color:white;padding:12px;font-size:12px;text-align:left;font-weight:800}td{border-bottom:1px solid #eef2f7;padding:12px;font-size:12px;vertical-align:middle}tr:nth-child(even) td{background:#fcfcfd}tr:last-child td{border-bottom:none}
        .summary{width:100%;margin:22px 0 0 0;border:1px solid #fed7aa;border-radius:18px;overflow:hidden;background:#fff;box-shadow:0 4px 14px rgba(249,115,22,.06)}.sumrow{display:grid;grid-template-columns:1fr 240px;gap:16px;padding:8px 14px;border-bottom:1px solid #e5e7eb;font-size:12px;align-items:center}.sumlabel{font-weight:700;line-height:1.3}.sumvalue{text-align:right;font-weight:800;white-space:nowrap;word-break:keep-all;overflow-wrap:normal}.sumfinal{background:#fff7ed;color:#f97316;font-size:13px}.sumfinal .sumvalue{font-size:15px;white-space:nowrap}.note{margin-top:16px;padding:10px 12px;background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;color:#7c2d12;line-height:1.55;font-size:12px}.tech-section{margin-top:26px;padding-top:14px;border-top:2px solid #f97316;page-break-inside:avoid}.tech-title{font-size:15px;font-weight:900;color:#111827;margin-bottom:4px;text-align:center}.tech-subtitle{font-size:11px;color:#6b7280;text-align:center;margin-bottom:12px}.tech-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:14px}.tech-card{border:1px solid #fed7aa;border-radius:18px;padding:16px 14px;background:linear-gradient(180deg,#fffaf5 0%,#ffffff 100%);text-align:center;page-break-inside:avoid;box-shadow:0 4px 14px rgba(249,115,22,.08);display:flex;flex-direction:column;align-items:center;justify-content:space-between;min-height:220px}.tech-name{font-size:13px;font-weight:900;color:#111827;line-height:1.45;min-height:42px;margin-bottom:12px;display:flex;align-items:center;justify-content:center;text-align:center}.tech-qr-wrap{display:inline-flex;align-items:center;justify-content:center;width:110px;height:110px;background:#fff;border:2px solid #fed7aa;border-radius:16px;padding:8px;text-decoration:none;cursor:pointer;transition:.2s}.tech-qr-wrap:hover{border-color:#f97316;transform:translateY(-2px)}.tech-qr{width:92px;height:92px;object-fit:contain}.tech-caption{display:block;font-size:10px;color:#ea580c;font-weight:900;margin-top:10px;text-decoration:none;line-height:1.4;padding:0 6px}.tech-caption:hover{text-decoration:underline}.signature-wrap{margin-top:42px;page-break-inside:avoid;break-inside:avoid}.signature-note{font-size:11px;color:#6b7280;text-align:right;margin-bottom:10px;font-style:italic}.signature{display:flex;justify-content:space-between;gap:28px;text-align:center;font-size:12px;page-break-inside:avoid;break-inside:avoid}.signature-box{flex:1;min-height:120px;display:flex;flex-direction:column;justify-content:flex-start}.signature-title{font-weight:800;margin-bottom:70px}.signature-line{color:#6b7280}.signature-date{text-align:right;margin-top:26px;margin-bottom:14px;color:#374151;font-size:12px;font-style:italic;page-break-inside:avoid;break-inside:avoid}@media print{body{padding:18px}.signature-wrap,.signature,.signature-date{page-break-inside:avoid!important;break-inside:avoid!important}}
      </style></head><body>
