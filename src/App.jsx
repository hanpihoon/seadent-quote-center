...
const [isLoggedIn, setIsLoggedIn] = React.useState(false);
  ...
  const exportQuotePdf = () => {
    ...
    win.document.write(`
      ...
      <div style="display:flex;justify-content:flex-start;margin-bottom:4px;padding-left:2px"><img src="/logo.png" style="width:82px;object-fit:contain"/></div><div class="header"><div style="display:flex;flex-direction:column;align-items:flex-start;text-align:left;gap:2px;width:100%"><div class="brand" style="margin-top:0">CÔNG TY CỔ PHẦN SEADENT</div><div class="sub">VP.HCM: 13 Đặng Tất, Phường Tân Định, TP.HCM<br/>VP.HN: Tầng 6, 110-112 Bà Triệu, Hà Nội<br/>Hotline: 0934831516<br/>Email: info@seadent.com.vn<br/>Website: seadent.com.vn</div></div><div class="meta" style="padding-top:0;text-align:right"><b>Ngày:</b> ${new Date().toLocaleDateString("vi-VN")}<br/><b>Mã báo giá:</b> SQC-${Date.now()}</div></div>
      <h2>BẢNG BÁO GIÁ</h2>
