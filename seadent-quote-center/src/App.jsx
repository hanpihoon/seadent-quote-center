...
const [isLoggedIn, setIsLoggedIn] = React.useState(false);
  ...
  const exportQuotePdf = () => {
    ...
    const productInfoRows = productInfoCards.length
      ? `<div class="product-info-section"><div class="product-info-grid"><div class="product-info-intro"><div class="product-info-header"><div class="product-info-title">THUYẾT MINH KỸ THUẬT SẢN PHẨM</div><div class="product-info-subtitle">Mỗi sản phẩm hiển thị hình ảnh và mã QR tài liệu kỹ thuật tương ứng</div></div>${productInfoCards[0]}</div>${productInfoCards.slice(1).join("")}</div></div>`
      : "";
