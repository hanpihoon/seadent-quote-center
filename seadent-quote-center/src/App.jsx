...
const [isLoggedIn, setIsLoggedIn] = React.useState(false);
  ...
  const exportQuotePdf = () => {
    ...
    const productInfoRows = cartItems
    ...
    win.document.write(`
      ...
      ${productInfoRows ? `<div class="product-info-section"><div class="product-info-header"><div class="product-info-title">THUYẾT MINH KỸ THUẬT SẢN PHẨM</div><div class="product-info-subtitle">Mỗi sản phẩm hiển thị hình ảnh và mã QR tài liệu kỹ thuật tương ứng</div></div><div class="product-info-grid">${productInfoRows}</div></div>` : ""}
      <script>
