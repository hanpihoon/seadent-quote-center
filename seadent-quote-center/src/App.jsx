      ...
      <div className={isLoggedIn ? "sq-page" : "sq-page login-blur"}>
        <main className="sq-shell">
          <div className="sq-banner">
            <img src={BANNER_URL} alt="SEADENT Banner" />
          </div>
